...
> **Beta.** 0.1.0 is the first public release, for DaVinci Resolve Studio 20
> or later on **macOS**.
...
3. **Generate**, listen in **Audio preview**, then **Place all clips** (or
   tick **Place on timeline when done**).
...
- **Anonymous usage data** is asked about on first run and in Settings. Your
