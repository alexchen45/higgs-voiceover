...
local function friendly_error(code, raw)
  ...
  elseif code == "404" then
    if mentions("voice") then
      return "That voice is no longer on your account. Pick another in Voices."
    end
  ...
  elseif code == "400" or code == "422" then
    if mentions("voice") then
      return "Boson didn't accept that voice. Pick another in Voices."
    end
