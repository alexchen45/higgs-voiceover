...
local DEFAULTS = {
  ...
  auto_place    = false,       -- put every clip of a finished run on the timeline
  pause_enabled = true,
  pause_ms      = 400,
  ...
  -- Nothing is sent anywhere yet; this only records the user's answer so the
  -- choice is already theirs on the day there is a backend to honour it.
